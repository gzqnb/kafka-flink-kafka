...
/**
 * @Auther: gzq
 * @Date: 2021/1/27 - 01 - 27 - 13:13
 * @Description: nevt.test
 */
@Component
public class Kafka_Flink_window {
    @Resource
...
//        设置事件时间
        ...
        WindowedStream<TemperatureFlink, String, TimeWindow> windowDataStream = keyedStream.timeWindow(Time.seconds(10));
        DataStream<TemperatureFlink> resultStream = windowDataStream.minBy("temp");
